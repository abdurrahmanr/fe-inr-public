			...
			<div className="grid grid-cols-5 gap-3">
				<div className="col-span-full lg:col-span-2 grid grid-cols-1 gap-3 lg:-ml-14">
					<div className="grid gap-3 grid-flow-col w-fit justify-self-end">
						<div className=' w-full h-full lg:w-[247.956px] lg:h-[345.69px] overflow-hidden rounded-primary'>
							<img src={data?.data[0].image} className='w-full h-full object-cover grayscale hover:grayscale-0 hover:scale-110 transition-all duration-500 hover:rotate-1' alt="" />
						</div>
						<div className='self-end w-full h-full lg:h-[282.344px] overflow-hidden rounded-primary'>
							<img src={data?.data[1].image} className='w-full h-full object-cover grayscale hover:grayscale-0 hover:scale-110 transition-all duration-500 hover:rotate-1' alt="" />
						</div>
					</div>
					<div className="grid gap-3 grid-flow-col w-fit">
						<div className='w-full h-full lg:w-[344.785px] lg:h-[292.298px] overflow-hidden rounded-primary'>
							<img src={data?.data[2].image} className='w-full h-full object-cover grayscale hover:grayscale-0 hover:scale-110 transition-all duration-500 hover:rotate-1' alt="" />
						</div>
						<div className='w-full h-full lg:h-[218.997px] overflow-hidden rounded-primary'>
							<img src={data?.data[3].image} className='w-full h-full object-cover grayscale hover:grayscale-0 hover:scale-110 transition-all duration-500 hover:rotate-1' alt="" />
						</div>
					</div>
				</div>
				<div className="lg:col-span-1 col-span-full w-full flex justify-center">
					<div className='w-2/3 lg:w-full lg:h-[354.739px] self-center overflow-hidden rounded-primary'>
						<img src={data?.data[4].image} className='h-full w-full object-cover grayscale hover:grayscale-0 hover:scale-110 transition-all duration-500 hover:rotate-1' alt="" />
					</div>
				</div>
				<div className="col-span-full lg:col-span-2 grid grid-cols-1 gap-3 lg:-mr-16 translate-y-0">
					<div className="grid gap-3 grid-flow-col w-fit">
						<div className='self-end w-full h-full lg:w-[262.435px] lg:h-[314.922px] overflow-hidden rounded-primary'>
							<img src={data?.data[5].image} className='w-full h-full object-cover grayscale hover:grayscale-0 hover:scale-110 transition-all duration-500 hover:rotate-1' alt="" />
						</div>
