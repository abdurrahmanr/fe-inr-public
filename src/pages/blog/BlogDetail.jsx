    ...
    return (
        <div className='w-full'>
            <div className='lg:px-[105px] mt-14 px-6 flex flex-col gap-3 w-full h-full'>
                <p className='font-bold capitalize text-yellowSecondary lg:text-base text-sm'>{data[0]?.author}</p>
            ...
            <div className=' px-6 lg:px-[105px] mt-14 flex flex-col gap-3 w-full h-full'>
                ...
                <div className='flex flex-col gap-6 leading-7 my-8 text-greyCol text-justify'>
